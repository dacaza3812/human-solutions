...
export default async function CasesPage() {
  ...
  return (
    <div className="grid gap-6 p-6 md:p-8">
      ...
      <Suspense fallback={<CasesLoading />}>{isAdvisor ? <AdvisorCasesSection /> : <ClientCasesSection />}</Suspense>

      {/* Quick Links/CTAs */}
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <Card className="bg-card/50">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Explorar Recursos</CardTitle>
            <FileText className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-bold">Biblioteca</p>
            <p className="text-xs text-muted-foreground">Accede a guías y artículos útiles.</p>
            <Button variant="link" className="p-0 h-auto mt-2 text-emerald-400">
              Ir a Recursos <ArrowRight className="ml-1 h-3 w-3" />
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card/50">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Ver Historial de Pagos</CardTitle>
            <DollarSign className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-bold">Transacciones</p>
            <p className="text-xs text-muted-foreground">Revisa tus pagos y facturas.</p>
            <Button variant="link" className="p-0 h-auto mt-2 text-emerald-400">
        ...
        <Card className="bg-card/50">
          ...
          <CardContent>
            <p className="text-2xl font-bold">Ayuda</p>
            <p className="text-xs text-muted-foreground">¿Necesitas asistencia? Contáctanos.</p>
            <Button variant="link" className="p-0 h-auto mt-2 text-emerald-400">
              Obtener Soporte <ArrowRight className="ml-1 h-3 w-3" />
            </Button>
          </CardContent>
        </Card>
      </div>
